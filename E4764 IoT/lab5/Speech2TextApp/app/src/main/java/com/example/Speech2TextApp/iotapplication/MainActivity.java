package com.example.Speech2TextApp.iotapplication;
...
public class MainActivity extends Activity {
    ...
    private void sendGet(String path, String urladdr, String msg) {
        ...
        client.get(path + msg , new AsyncHttpResponseHandler() {
            ...
            public void onFailure(int i, Header[] headers, byte[] bytes, Throwable throwable) {
                Toast.makeText(getApplicationContext(), "Can not reach server: " + urlPath, Toast.LENGTH_LONG).show();
            }
        });
